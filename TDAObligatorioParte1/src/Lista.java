...
public class Lista<T> {
    ...
    public void Push(Node<T> siguiente){
        if (siguiente == null || siguiente.val == null) return;
    ...
    /**
     * Imprime todos los elementos de la lista en base a su clave
    ...
    public String Print(){
        ...
        StringBuilder printString = new StringBuilder(first.Print());
        while(aux != null){
            printString.append("->").append(aux.Print());
            aux = aux.next;
        }
